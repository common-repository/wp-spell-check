				...
				jQuery(function($){
					...
					wpsc_form.submit(function(event) { 
						...
						var submit = $.post('<?php echo esc_html($this->api); ?>', form_data);
                                                ...
                                                if ($('input[name=contact]:checked').val() == 'Yes') { window,open("https://www.wpspellcheck.com/report-an-issue?utm_source=baseplugin&utm_campaign=plugindeac&utm_content=9.8","_blank"); }
                                                if ($('input[name=opt]:checked').val() == "Don't know what it does") { window,open("https://www.wpspellcheck.com/support?utm_source=baseplugin&utm_campaign=plugindeac&utm_content=9.8","_blank"); }
				...
				<div class="wpsc_survey_wrapper">
						...
						?>
							...
							<label for="wpsc_survey_option_dont_know" class="wpsc_survey_label">
								...
								<div class="wpsc_survey_option_details">You may check out our <strong>free video tutorials</strong> for WP Spell Check <a href="https://www.wpspellcheck.com/support?utm_source=baseplugin&utm_campaign=plugindeac&utm_content=9.8" target="_blank">here</a></div>
							</label>
							<?php
								} elseif ($number == 3) {
							?>
							...
							<label for="wpsc_survey_option_other" class="wpsc_survey_label">
								...
								<input class="wpsc_survey_option_details" type="text" placeholder="Please enter details" />
                                                                <div class="wpsc_survey_option_details"><a href="https://www.wpspellcheck.com/report-an-issue?utm_source=baseplugin&utm_campaign=plugindeac&utm_content=9.8" target="_blank">Get in touch</a> with us to fix this problem and get Free access to WP Spell Check Pro for 1 year! (valued at $99)</div>
							</label>
						</div>
